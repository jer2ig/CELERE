...
def parse_opt():
    ...
    parser.add_argument('--combine', nargs='+', type=str, default=None, help='weights for damage detection if both classification and detection run')
